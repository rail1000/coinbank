...
import com.gongchuang.ethtoken.ui.activity.BankAccountManageActivity;
...
public class MineFragment extends BaseFragment {
    ...
    @OnClick({R.id.lly_wallet_manage, R.id.lly_contacts, R.id.lly_msg_center
            , R.id.lly_system_setting, R.id.lly_trade_recode,R.id.lly_personal_center})
    public void onClick(View view) {
        Intent intent = null;
        switch (view.getId()) {
            case R.id.lly_personal_center:
                intent = new Intent(getActivity(), BankAccountManageActivity.class);
