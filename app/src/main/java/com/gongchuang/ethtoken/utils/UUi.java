...
//    }
    ...
    public static int dip2px(float dipValue) {
        float scale = TokenApplication.getsInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float fontScale = TokenApplication.getsInstance().getResources().getDisplayMetrics().scaledDensity;
