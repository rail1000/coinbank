...
public class WalletDaoUtils {
    public static ETHWalletDao ethWalletDao = TokenApplication.getsInstance().getDaoSession().getETHWalletDao();
    ...
    public static void updateWalletBanlance(long walletId, String banlance) {
        ETHWallet wallet = ethWalletDao.load(walletId);
        wallet.setBanlance(banlance);
        ethWalletDao.update(wallet);
    }
