 ...
 * @date 2016/8/3.
 */
public class TokenApplication extends MultiDexApplication {

    private static TokenApplication sInstance;
    ...
    public static RefWatcher getRefWatcher(Context context) {
        count = 0;
        TokenApplication application = (TokenApplication) context.getApplicationContext();
...
//        CrashHandler.getInstance().init(this);
    ...
    public static TokenApplication getsInstance() {
        return sInstance;
    }
